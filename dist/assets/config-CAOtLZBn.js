import{A as I,_ as k,C as v,B as ee,E as te,D as j,F as Ae,G as _,y as Ee,z as _e,H as Ce,I as Oe}from"./index-35c79a8a-CzBIBpeT.js";const ne="@firebase/installations",K="0.6.18";/**
 * @license
 ...
 */const ie=1e4,oe=`w:${K}`,re="FIS_v2",Ne="https://firebaseinstallations.googleapis.com/v1",De=60*60*1e3,Pe="installations",Fe="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $e({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const i=se(e),o=de(e),r=t.getImmediate({optional:!0});if(r){const u=await r.getHeartbeatsHeader();u&&o.append("x-firebase-client",u)}const a={fid:n,authVersion:re,appId:e.appId,sdkVersion:oe},c={method:"POST",headers:o,body:JSON.stringify(a)},d=await le(()=>fetch(i,c));if(d.ok){const u=await d.json();return{fid:u.fid||n,registrationStatus:2,refreshToken:u.refreshToken,authToken:ce(u.authToken)}}else throw await ue("Create Installation",d)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Le=/^[cdef][\w-]{21}$/,M="";function Be(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=Ve(e);return Le.test(n)?n:M}catch{return M}}function Ve(e){return qe(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ze="firebase-installations-database",We=1,b="firebase-installations-store";let C=null;function $(){return C||(C=j(ze,We,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(b)}}})),C}async function S(e,t){const n=A(e),o=(await $()).transaction(b,"readwrite"),r=o.objectStore(b),a=await r.get(n);return await r.put(t,n),await o.done,(!a||a.fid!==t.fid)&&ge(e,t.fid),t}async function we(e){const t=A(e),i=(await $()).transaction(b,"readwrite");await i.objectStore(b).delete(t),await i.done}async function E(e,t){const n=A(e),o=(await $()).transaction(b,"readwrite"),r=o.objectStore(b),a=await r.get(n),c=t(a);return c===void 0?await r.delete(n):await r.put(c,n),await o.done,c&&(!a||a.fid!==c.fid)&&ge(e,c.fid),c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function q(e){let t;const n=await E(e.appConfig,i=>{const o=Ge(i),r=Je(e,o);return t=r.registrationPromise,r.installationEntry});return n.fid===M?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Ge(e){const t=e||{fid:Be(),registrationStatus:0};return be(t)}function Je(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(w.create("app-offline"));return{installationEntry:t,registrationPromise:o}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},i=Ye(e,n);return{installationEntry:n,registrationPromise:i}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:Qe(e)}:{installationEntry:t}}async function Ye(e,t){try{const n=await $e(e,t);return S(e.appConfig,n)}catch(n){throw ae(n)&&n.customData.serverCode===409?await we(e.appConfig):await S(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function Qe(e){let t=await H(e.appConfig);for(;t.registrationStatus===1;)await fe(100),t=await H(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:i}=await q(e);return i||n}return t}function H(e){return E(e,t=>{if(!t)throw w.create("installation-not-found");return be(t)})}function be(e){return Xe(e)?{fid:e.fid,registrationStatus:0}:e}function Xe(e){return e.registrationStatus===1&&e.registrationTime+ie<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function st(e){const t=e,{installationEntry:n,registrationPromise:i}=await q(t);return i?i.catch(console.error):L(t).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ct(e,t=!1){const n=e;return await ut(n),(await L(n,t)).token}async function ut(e){const{registrationPromise:t}=await q(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ot(e,t){const n=await x(e),i=Se(t),o={method:"POST",headers:n,body:JSON.stringify(i)};let r;try{r=await(await fetch(V(e.appConfig),o)).json()}catch(a){throw l.create("token-subscribe-failed",{errorInfo:a?.toString()})}if(r.error){const a=r.error.message;throw l.create("token-subscribe-failed",{errorInfo:a})}if(!r.token)throw l.create("token-subscribe-no-token");return r.token}async function Nt(e,t){const n=await x(e),i=Se(t.subscriptionOptions),o={method:"PATCH",headers:n,body:JSON.stringify(i)};let r;try{r=await(await fetch(`${V(e.appConfig)}/${t.token}`,o)).json()}catch(a){throw l.create("token-update-failed",{errorInfo:a?.toString()})}if(r.error){const a=r.error.message;throw l.create("token-update-failed",{errorInfo:a})}if(!r.token)throw l.create("token-update-no-token");return r.token}async function Dt(e,t){const i={method:"DELETE",headers:await x(e)};try{const r=await(await fetch(`${V(e.appConfig)}/${t}`,i)).json();if(r.error){const a=r.error.message;throw l.create("token-unsubscribe-failed",{errorInfo:a})}}catch(o){throw l.create("token-unsubscribe-failed",{errorInfo:o?.toString()})}}function V({projectId:e}){return`${bt}/projects/${e}/registrations`}async function x({appConfig:e,installations:t}){const n=await t.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e.apiKey,"x-goog-firebase-installations-auth":`FIS ${n}`})}function Se({p256dh:e,auth:t,endpoint:n,vapidKey:i}){const o={web:{endpoint:n,auth:t,p256dh:e}};return i!==Te&&(o.web.applicationPubKey=i),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bt(e){if(!e||!e.options)throw P("App Configuration Object");if(!e.name)throw P("App Name");const t=["projectId","apiKey","appId","messagingSenderId"],{options:n}=e;for(const i of t)if(!n[i])throw P(i);return{appName:e.name,projectId:n.projectId,apiKey:n.apiKey,appId:n.appId,senderId:n.messagingSenderId}}function P(e){return l.create("missing-app-config-values",{valueName:e})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ut(e,t){if(!t&&!e.swRegistration&&await xt(e),!(!t&&e.swRegistration)){if(!(t instanceof ServiceWorkerRegistration))throw l.create("invalid-sw-registration");e.swRegistration=t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
