import{z as I,_ as k,C as v,A as ee,E as te,B as j,F as Ae,D as _,x as Ee,y as _e,G as Ce,H as Oe}from"./index.esm2017-DEs6YOCN.js";const ne="@firebase/installations",K="0.6.18";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Le=/^[cdef][\w-]{21}$/,M="";function xe(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=Be(e);return Le.test(n)?n:M}catch{return M}}function Be(e){return qe(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
