...
export const registerServiceWorker = async () => {
  ...
  if (import.meta.env.DEV && 'serviceWorker' in navigator) {
    try {
      ...
      if (registration) {
        console.log('Development mode: Unregistering existing service worker to avoid React conflicts');
      ...
      console.warn('Error unregistering service worker in development:', error);
    }
    return null;
  }
